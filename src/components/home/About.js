...
const About = () => {
  return (
    <section id='about' className="flex items-center justify-center h-full md:h-screen  w-full bg-gray-100">
      <div className="flex flex-col md:flex-row items-center max-w-4xl mx-auto p-10 shadow-lg rounded-lg md:bg-white bg-gray-100">
