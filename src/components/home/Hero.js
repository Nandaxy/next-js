    ...
    <div className="flex flex-col md:flex-row h-screen w-full  justify-between items-center">
      <div className="w-full h-1/2 flex  items-center md:w-1/2 md:h-full">
        <div className="p-10 md:p-20">
          ...
          <div>
            <h2 className="flex font-medium text-secondary text-lg mb-5 lg:text-2xl text-[#64748b]">
              Beginner Web
          ...
          <p className="font-medium text-secondary mb-10 leading-relaxed text-[#64748b]">
            Nice to meet you,
            <span className="text-[#000] font-semibold"> Thank you</span>
          </p>
          <Link href="#contact" className="bg-primary text-base font-semibold text-white py-3 px-8 rounded-full hover:shadow-xl hover:text-black transition duration-300 ease-in-out">Contact</Link>
        </div>
      </div>
